"""
HMC Room Draw Backend Black Box Testing
=====================
...
class TestDrawLogic(unittest.TestCase):
    ...
    def testComparePriority1(self):
        ...
        self.assertEqual(DrawLogic.comparePriority("98923","93933"),User1)
        ...
        self.assertEqual(DrawLogic.comparePriority("97383","98234"),User3)
    ...
    def testComparePriority2(self):
        ...
        """
        # Pre-conditions are two user objects
        # Different graduation years and same priority numbers
        User1 = User("98923", "XXXXX", "XXXXX", "XXXXXXX@g.hmc.edu", "2023",42)
        User2 = User("93933", 'XXXXX', "XXXXX", "XXXXXXX@g.hmc.edu", "2024",42)
        self.assertEqual(DrawLogic.comparePriority(User1,User2),User1)

        # Different graduation years and different priority numbers
        User3 = User("97383", "XXXXX", "XXXXX", "XXXXXXX@g.hmc.edu", "2023",42)
        User4 = User("98234", 'XXXXX', "XXXXX", "XXXXXXX@g.hmc.edu", "2024",81)
        self.assertEqual(DrawLogic.comparePriority(User3,User4),User3)
...
class TestDrawState(unittest.TestCase):
    ...
    def testGetUserIn(self):
        ...
        RoomHasUser = Room("98292", "Case", 2, None, 202, True)
        UserOfRoom = User("96782", "XXXXX", "XXXXX", "XXXXXXX@g.hmc.edu", "2023",42)
        RoomHasNoUser = Room("94562", "Case", 2, None, 201, False)

        # User is in the room
        self.assertEquals(DrawState.getUserIn("98292"),UserOfRoom)
        # User is not in the room
        self.assertEquals(DrawState.getUserIn("94562"),None)
    ...
    def testGetRoomOf(self):
        ...
        """
        # Pre-condition is one Room object and one User object
        UserHasRoom = User("96782", "XXXXX", "XXXXX", "XXXXXXX@g.hmc.edu", "2023",42)
        RoomOfUser = Room("98292", "Case", 2, None, 202, True)
        UserHasNoRoom = User("99001", 'XXXXX', "XXXXX", "XXXXXXX@g.hmc.edu", "2023",32)
        # More tests would include testing the retrieval of the Room and User 
        # object from the database

        # User is in the room
        self.assertEquals(DrawState.getRoomOf("96782"),RoomOfUser)
        # User is not in the room
        self.assertEquals(DrawState.getRoomOf("99001"),None)
